...
|             |             |             |             |
|:-----------:|:-----------:|:-----------:|:-----------:|
| [`프로그램의 기본`](/theory/Chapter/01/README.md) | [`데이터형과 변수 (현재)`](/theory/Chapter/02/README.md) | [`제어문`](/theory/Chapter/03/README.md) | [`함수`](/theory/Chapter/04/README.md) |
...
![img](/theory/Chapter/02/image6c.png "부동소수점방식")

부동소수점 방식에서 값의 여러 가지 표현되는 것을 막기 위해서 실수를 1.xxxX2의 n승로 나타낸다. xxx는 가수 부분이며 실수의 정밀도를 결정하며 2의 n승중 n승은 지수이며 실수의 범위를 결정한다. xxx와 n은 2진수로 표현된다.

**부동 소수점으로 표현된 실수의 정밀도는 실수의 가수부분에 의해서 결정되고, 실수의 범위는 지수 부분에 의해 결정된다.**
실수의 정밀도에는 단정도와 배정도가 있다. 단정도 실수를 나타낼때는 float형(32비트)을 사용하고 배정도 실수를 나타낼 때는 double(64비트)형을 사용한다.

![img](/theory/Chapter/02/image7.png "단정도와 배정도")
### (2)실수형의 유효 범위
